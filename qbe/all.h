...
void qbe_addins(Ins **, uint *, Ins *);
void qbe_addbins(Blk *, Ins **, uint *);
...
void qbe_filldepth(Fn *);
Blk *qbe_lca(Blk *, Blk *);
void qbe_fillloop(Fn *);
void qbe_simpljmp(Fn *);
int qbe_reaches(Fn *, Blk *, Blk *);
int qbe_reachesnotvia(Fn *, Blk *, Blk *, Blk *);
...
/* ssa.c */
void qbe_adduse(Tmp *, int, Blk *, ...);
void qbe_filluse(Fn *);
void qbe_ssa(Fn *);
void qbe_ssacheck(Fn *);

/* copy.c */
void qbe_narrowpars(Fn *fn);
Ref qbe_copyref(Fn *, Blk *, Ins *);
Ref qbe_phicopyref(Fn *, Blk *, Phi *);

/* fold.c */
int qbe_foldint(Con *, int, int, Con *, Con *);
Ref qbe_foldref(Fn *, Ins *);

/* gvn.c */
extern Ref con01[2];  /* 0 and 1 */
int qbe_zeroval(Fn *, Blk *, Ref, int, int *);
void qbe_gvn(Fn *);
