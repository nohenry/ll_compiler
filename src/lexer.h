...
typedef enum {
    ...
    LL_TOKEN_KIND_ASSIGN_AND,
    LL_TOKEN_KIND_ASSIGN_OR,
    LL_TOKEN_KIND_ASSIGN_XOR,
    LL_TOKEN_KIND_ASSIGN_BIT_AND,
    LL_TOKEN_KIND_ASSIGN_BIT_OR,
    LL_TOKEN_KIND_ASSIGN_BIT_XOR,
    LL_TOKEN_KIND_ASSIGN_LEFT_SHIFT,
    LL_TOKEN_KIND_ASSIGN_RIGHT_SHIFT,
    ...
    LL_TOKEN_KIND_LEFT_SHIFT,
    LL_TOKEN_KIND_RIGHT_SHIFT,
